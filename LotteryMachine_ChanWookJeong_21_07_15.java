...
public class LotteryMachine_ChanWookJeong_21_07_15 {
    public static void main(String[] args) {
//////////////////////////////////////////////////////////////////////////////////////////
        /*
        1. 컴퓨터의 추첨.
        컴퓨터가 추첨한 6개의 랜덤한 숫자를 numbers라는 리스트에 저장하는 파트
         */
        ...
        */
        ...
        for (int i = 0; i<user_numbers.size(); i++) {
            if (com_numbers.contains(user_numbers.indexOf(i)) == true) {
                ...
                // 유저가 뽑은 숫자가 com_numbers내에 있다면 맞춘만큼 j에 1이 더해지도록 설정//
                j++;
            }
        } if (j == 6) {
            ...
            System.out.println("당첨번호 : " + com_numbers + " 뽑으신 번호 : " + user_numbers + ", 아쉽지만 당첨내역이 없습니다");
        }
